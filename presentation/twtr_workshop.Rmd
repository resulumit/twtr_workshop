...
- `rtweet` ([Kearney, 2020](https://cran.r-project.org/web/packages/rtweet/index.html)), for collecting tweets
    ...
    - alternatives: `academictwitteR` ([Barrie and Chun-ting Ho, 2022](https://cran.r-project.org/web/packages/academictwitteR/index.html)) for academic research access; [running Python code in R](https://blog.twitter.com/developer/en_us/topics/tips/2020/running-the-python-package-for-search-tweets-in-r.html)
