...
44) Create a new variable without links and emojis
...
Note that
   ...
   - there is a `str_remove` version, which removes the first occurrence only
---
## Data Preperation &mdash; Remove Punctuations
...
- make sure each row has at most one hashtag
