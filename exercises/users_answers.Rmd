...
If these exercises are too easy for you, I recommend analysing your own dataset or conducting additional analyses on the same dataset in parallel. If they are on the other hand too hard, the comments in the chunks might help you. If they are still too inaccessible to you, you may wish to follow on with the `users_answers.Rmd` instead, which include the code.
